...
export interface AgentRead {
  ...
  /** Whether this agent was discovered from a pre-existing OpenClaw deployment. When True, the candidate's provisioning loops (templates sync, lifecycle reconcile) skip the row so they don't overwrite operator-tuned gateway config. */
  is_gateway_managed?: boolean;
